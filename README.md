...
Выводит, сообщение пользователю - _**Вы успешно приобрели билет на такое место ...**_
Страница с результатом неудачной покупки билета (билет уже купили). 
Выводит, сообщение пользователю - _**Не удалось приобрести билет на заданное место.**_
