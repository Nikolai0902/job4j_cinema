...
public class FilmSessionsDto {
    ...
    public FilmSessionsDto() {
    }

    public FilmSessionsDto(int id, int filmId, String filmName, int hallsId,
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && filmId == that.filmId
                && hallsId == that.hallsId && price == that.price;
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, filmId, hallsId, price);
    }
}
